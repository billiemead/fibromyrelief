...
Please install and activate it before starting to use the theme Medeus.
...
Theme documentation is available on https://medeus.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Medeus is Fontello.
