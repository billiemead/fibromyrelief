...
(function() {
	...
	medeus_add_filter( 'medeus_filter_select_container_selector', function(selector) {
	...
	jQuery( '.medeus_woocommerce_filters_button,.sidebar > .sidebar_close,.sidebar_overlay' ).on( 'click', function(e) {
