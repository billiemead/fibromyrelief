...
if ( ! function_exists( 'medeus_trx_addons_get_css' ) ) {
	add_filter( 'medeus_filter_get_css', 'medeus_trx_addons_get_css', 10, 2 );
	function medeus_trx_addons_get_css( $css, $args ) {
