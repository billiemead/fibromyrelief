...
if ( ! function_exists( 'medeus_woocommerce_get_css' ) ) {
	add_filter( 'medeus_filter_get_css', 'medeus_woocommerce_get_css', 10, 2 );
	function medeus_woocommerce_get_css( $css, $args ) {
...
$fdir = medeus_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
